...
class SuppWielandGymnasium(BaseSupplier):
    ...
    def update(self, db):
        page = download_website("https://www.wieland-gymnasium.de/index.php/WG%20Termine/Vertretungsplan/")

        #prepare, get rid of "bla' >" .... convert to "bla'>"
